...
from app.modules.proxy._service.support import _HTTPBridgeCloseReason, _HTTPBridgeSession, _HTTPBridgeSessionKey
...
class _HTTPBridgeServiceProtocol(Protocol):
    ...
    def _take_websocket_request_state_reservation(self, *args: Any, **kwargs: Any) -> Any: ...
    def _track_cancel_safe_cleanup_task(self, *args: Any, **kwargs: Any) -> None: ...
