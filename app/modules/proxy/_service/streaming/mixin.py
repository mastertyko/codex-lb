        ...
        *,
        ...
        try:
            ...
            if event and event.type in ("response.failed", "error"):
                ...
                raw_error_type, raw_error_message, raw_error_param, code, classifier_code = _stream_error_fields(
                    error,
                    event_type,
                    first_payload,
                    preserve_raw=preserve_raw_sse_line,
                )
