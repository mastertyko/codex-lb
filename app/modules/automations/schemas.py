...
AUTOMATION_REASONING_EFFORTS = ("minimal", "low", "medium", "high", "xhigh", "max")
_AUTOMATION_REASONING_EFFORT_PATTERN = rf"(?i)^({'|'.join(AUTOMATION_REASONING_EFFORTS)})$"
...
class AutomationJobCreateRequest(DashboardModel):
    ...
    reasoning_effort: str | None = Field(default=None, pattern=_AUTOMATION_REASONING_EFFORT_PATTERN)
