...
| `af888fd` stale-diagnostic expectation repair | Missing supporting coverage, now semantically ported | Restore equivalent sanitizer, transport, owner-source, and request-log assertions against the beta.3-shaped implementation. |
